...
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports UART_OP]
...
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports UART_ERROR]
#set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports MIG_WREN]
