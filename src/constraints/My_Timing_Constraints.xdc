...
set_max_delay -from [get_pins {GRID_LINES_BUFFER/TOTAL_NUM_OF_FILLED_LINES_reg*/C}] -to [get_pins {GRID_LINES_BUFFER/SYNCHRONIZER/DATA_OUT_1_reg*/D}] 12.0
set_max_delay -from [get_pins {GRID_LINES_BUFFER/LINE_BEING_FILLED_reg*/C}] -to [get_pins {GRID_LINES_BUFFER/SYNCHRONIZER/DATA_OUT_2_reg*/D}] 12.0
set_max_delay -from [get_pins GRID_LINES_BUFFER/SYNC_CONTROL_reg/C] -to [get_pins {GRID_LINES_BUFFER/SYNCHRONIZER/CONTROL_SIGNAL_reg[0]/D}] 12.0